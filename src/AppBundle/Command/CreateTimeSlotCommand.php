...
//        $restaurantRepository = $em->getRepository('AppBundle:Restaurant');
...
//        $question6 = new Question('<fg=yellow>Id of the Restaurant ?</> :' , null);
...
//        $timeSlot->setRestaurant($restaurantRepository->find($restaurantId));
