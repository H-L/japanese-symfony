...
class Review
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Maid", inversedBy="review")
     */
    private $maid;
     ...
     * Set maid
     *
     * @param \AppBundle\Entity\Maid $maid
     *
     * @return Review
     */
    public function setMaid(\AppBundle\Entity\Maid $maid = null)
    {
        $this->maid = $maid;
