...
class TimeslotController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            //TODO maid must be 15 yo +
            //TODO if maid already work on this hours on this day
            //TODO if this would make more than 4hours of work for maid
    ...
    public function deleteAction(Request $request, Timeslot $timeslot)
    {
        ...
        return $this->redirectToRoute('back-office_timeslot_index');
    }
